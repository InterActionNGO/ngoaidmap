...
ActiveRecord::Schema.define(version: 20171218133912) do
  ...
  create_table "sites_tags", id: false, force: :cascade do |t|
    t.integer "site_id"
    t.integer "tag_id"
  end

  add_index "sites_tags", ["site_id"], name: "index_sites_tags_on_site_id", using: :btree
  add_index "sites_tags", ["tag_id"], name: "index_sites_tags_on_tag_id", using: :btree
